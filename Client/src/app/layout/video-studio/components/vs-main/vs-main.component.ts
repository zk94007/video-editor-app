...
@Component({
  selector: 'app-vs-main',
  templateUrl: './vs-main.component.html',
  styleUrls: ['./vs-main.component.scss']
})
export class VsMainComponent implements OnInit, OnDestroy {
  ...
  constructor(private vsService: VideoStudioService, private route: ActivatedRoute, private router: Router) {
    ...
    vsService._load(localStorage.getItem('selectedProjectId'));
    // });
  }
