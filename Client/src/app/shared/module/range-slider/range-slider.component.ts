...
export class RangeSliderComponent implements ControlValueAccessor, OnInit, OnChanges {
    public slider: any;
    public handles: any[];
    ...
    ngOnInit(): void {
        const inputsConfig = JSON.parse(JSON.stringify({
            ...
            limit: this.limit,
            start: (this.formControl !== undefined ? this.formControl.value : this.ngModel) || 0,
            step: this.step,
