import {NgModule, Component, ElementRef, OnDestroy, Input, Output, SimpleChange, EventEmitter, forwardRef, Renderer2,NgZone,ChangeDetectorRef, HostListener} from '@angular/core';
...
export class Slider implements OnDestroy,ControlValueAccessor {
    ...
    ngOnInit() {
        ...
        if (this.move) {
            this.move.subscribe((offset) => {
                this.updateValue(this.handleValues[this.handleIndex] + offset);
                // this.updateDomData();
